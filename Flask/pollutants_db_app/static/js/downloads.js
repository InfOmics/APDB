...
$(document).ready(function(){
    $('button#descriptor_download').on('click', function(e) {
        ...
        window.location.replace(`http://localhost:5000/apdb/home/browse-descriptors/download?descriptor=${name}`);
...
$(document).ready(function(){
    $('button#model_download').on('click', function(e) {
        ...
        window.location.replace(`http://localhost:5000/apdb/home/browse-similarities/download?model=${name}`);
...
$(document).ready(function(){
    $('button#db_download').on('click', function(e) {
        ...
        window.location.replace(`http://localhost:5000/apdb/downloads-contacts/db?format=${name}`);
